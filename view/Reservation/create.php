                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" value="<?php echo $relance ?>" name="relance" id="relance"/>
                            ...
                            <div class="col-md-12 text-center">
                               ...
                               <label class="card-header" for="reponse"> <i class="fa fa-wrench" aria-hidden="true"></i> Réponse</label><br>

                            <input type="radio" name="reponse" id="reponse" value="1" required/> Oui
                            <input type="radio" name="reponse" id="reponse" value="0" required/> Non<br>
